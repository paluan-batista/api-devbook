...
// NovoRepositoryDeUsuarios cria um repositório de usuários
func NovoRepositoryDeUsuarios(db *sql.DB) *Usuarios {
	return &Usuarios{db}
}
...
func (repository Usuarios) PararDeSeguir(usuarioID, seguidorID uint64) error {
	statement, erro := repository.db.Prepare(
